...
#define LT1 LT(MO(1), KC_DEL)
#define LT2 LT(MO(2), KC_ENT)
...
const uint16_t PROGMEM keymaps[3][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        ...
        KC_LSFT,    KC_Z,       KC_X,       KC_C,       KC_D,       KC_V,       KC_QUOT,    KC_BSLS,    KC_K,       KC_H,      KC_COMM,     KC_DOT,     KC_SLSH,    RGB_TOG,
        KC_LCTL,    KC_NO,      KC_NO,      KC_NO,      KC_NO,      KC_BSPC,    LT1,        LT2,        KC_SPC,     MO(2),     KC_SPC,      KC_NO,      KC_NO,      QK_BOOT
    ),
    [1] = LAYOUT(
